...
AMazescapeCharacter::AMazescapeCharacter()
{
...
void AMazescapeCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AMazescapeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void AMazescapeCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMazescapeCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
